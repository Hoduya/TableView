...
final class ViewController: UIViewController {
    ...
    func setupNaviBar() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(addMovieData))
    }
...
extension ViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // show 는 pushViewController 상위 개념. 아이패드에서 멀티태스킹으로 show 할 수 있다.
